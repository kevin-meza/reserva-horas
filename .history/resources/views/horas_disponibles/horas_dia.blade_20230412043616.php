...
@endphp
        ...
        <tr>
            ...
            <td><h1>{{ \Carbon\Carbon::parse($horasxDia->fecha)->format('l j \\d\\e F \\d\\e Y') }}</h1></td>
        </tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <table>
                ...
                <tr>
                    <td>  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submmit" class="btn btn-primary">Guardar</button></td>
                </tr>
            </table>
...
'<input type="hidden" id="id_especialidad" name="id_especialidad" value="'+id_especialidad+'">'  +
            '<div class="row"><div class="col">Fecha: ' + fecha +'</div>'+
            '<div class="col">Especialidad: ' + id_especialidad +'</div></div>'+
            '<div class="row"><div class="col">Especialista: ' + nombre +'</div>'+
            '<div class="col"> Hora: ' + hora+'</div></div>';
