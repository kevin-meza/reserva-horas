...
<td>
    <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="id_especialidad" id="id_especialidad" >
        ...
        @endforeach
            ...
            <div class="form-group">
                <label for="select-input">Selecciona una opción:</label>
                <input type="text" name="id_especialidad" class="form-control" list="options-list" id="select-input" placeholder="Escribe para buscar...">
                <datalist id="options-list">
                    @foreach ($listaEspecialidades as $especialidad)

                    <option value="{{$especialidad->id_especialista ." ".$especialista->nombre." ".$especialista->apellido." ".$especialista->especialidad }}">{{$especialista->nombre." ".$especialista->apellido ." ".$especialista->rut ." ".$especialista->especialidad }} </option>
