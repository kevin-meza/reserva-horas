...
<tr>
    ...
    <td>
       <input type="text" value="{{$horasxRut->nombre}}" style="visibility: none">
    </td>
    <td>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="obtenerValorSeleccionado({{$horasxRut->id_fecha}},'{{$horasxRut->fecha}}','{{$horasxRut->hora}}',{{$horasxRut->id_especialista}})">
            Launch demo modal
          </button>
    </td>
</tr>
