        ...
        @endforeach
            ...
            <div class="form-group">
                ...
                <datalist id="options-list">
                    ...
                    <option value="{{$especialidad->id ." ".$especialidad->especialidad." ".$especialista->apellido." ".$especialista->especialidad }}">{{$especialista->nombre." ".$especialista->apellido ." ".$especialista->rut ." ".$especialista->especialidad }} </option>
