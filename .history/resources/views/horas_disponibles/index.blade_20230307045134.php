...
@endforeach
    ...
    <div class="form-group">
        ...
        <datalist id="options-list">
            ...
            <option value="{{$especialista->id_especialista ."".$especialista->nombre}}">{{$especialista->nombre." ".$especialista->apellido ." ".$especialista->rut ." ".$especialista->especialidad }} </option>
