...
<tr>
    ...
    <td>
        <input type="text" value="{{$horasxRut->id_especialidad}}">
    </td>
    <td>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="obtenerValorSeleccionado({{$horasxRut->id_fecha}},'{{$horasxRut->fecha}}','{{$horasxRut->hora}}',{{$horasxRut->id_especialista}},'{{$horasxRut->nombre}}',{{$horasxRut->id_especialidad}}' )">
            Launch demo modal
          </button>
    </td>
</tr>
...
function obtenerValorSeleccionado(idFecha,fecha,hora,id_especialista,id_especialidad) {
...
var datos = '<input type="text" id="id_fecha" name="id_fecha" value="'+idFecha+'">' +
'<input type="text" id="id_especialista" name="id_especialista" value="'+id_especialista+'">'  +
            '<br>dia: ' + fecha +
            '<br>es: ' + id_especialidad +
            '<br>hora: ' + hora+'';
