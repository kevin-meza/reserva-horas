...
<tr>
   <td>
    <select class="form-select rounded-0" data-bs-show-search="true" name="id_especialidad" id="id_especialidad">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" list="options-list" id="select-input" placeholder="Escribe para buscar...">
    <datalist id="options-list">
      <option value="daniel 1"></option>
