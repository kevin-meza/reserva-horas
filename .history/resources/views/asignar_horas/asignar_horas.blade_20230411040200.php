...
<script>
    ...
    <tr><td>
    <button onclick="selectAll()" class="btn btn-outline-success">Seleccionar todo</button></td></tr>
    <tr><td><button onclick="deselectAll()" class="btn btn-outline-warning">Deseleccionar todo</button></td></tr>
</tr>
<td><button type="submit" class="btn btn-primary">Guardar</button></td></tr>
</table>
</form>
