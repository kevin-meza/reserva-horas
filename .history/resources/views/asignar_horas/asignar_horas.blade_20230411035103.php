...
<script>
    ...
    <button onclick="selectAll()" class="btn btn-outline-success">Seleccionar todo</button>
    <button onclick="deselectAll()" class="btn btn-outline-warning">Deseleccionar todo</button>
