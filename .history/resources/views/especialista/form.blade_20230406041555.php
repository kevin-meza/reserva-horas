@include('pantallas/head')
    ...
    <div class="container mt-2">
        ...
        @endif
        <form action="{{ route('especialista.store') }}" method="POST" enctype="multipart/form-data" name="fespecialista" >
            @csrf
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Nombres:</strong>
                        <input type="text" name="nombre" class="form-control" placeholder="Nombre Especialista" required pattern="[a-z]>
                        @error('nombre')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="apellido" class="form-control" placeholder="apellidos" required pattern="[a-z]">
                        @error('apellido')
                ...
                <br>
                <button type="submit" class="btn btn-primary ml-3" onclick="valida_envia()" >Submit</button>
            </div>
