            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" class="form-control" placeholder="Nombre Especialista" >
                        @error('nombre')
                ...
                <br>
                <button type="button" class="btn btn-primary ml-3" onclick="valida_envia()" >Submit</button>
            </div>
