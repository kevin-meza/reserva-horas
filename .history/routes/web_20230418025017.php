...
Route::post('/horas_disponibles/store', [App\Http\Controllers\HorasDisponiblesController::class,'store'])->name('horas_disponibles.store');

// Route::resource('especialista',EspecialistaController::class);
...
Route::resource('/asignar_horas', App\Http\Controllers\AsignarHorasController::class);
 ...
 Route::resource('/graficos', App\Http\Controllers\AsignarHorasController::class);
