...
Route::get('/asignar_horas', [App\Http\Controllers\HorasDisponiblesController::class,'asignarHoras']);
Route::post('/asignar_horas/ingresarHoras', [App\Http\Controllers\HorasDisponiblesController::class,'ingresarHoras']);
