...
class AsignarHorasController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select("*")
        ->get();
        return redirect()->route('asignar_horas.index')->with(['mensaje' => 'Especialista Editado'],$listaEspecialistas);
...
public function store(Request $request)
{
    ...
    return redirect()->route('asignar_horas.index')->with(['mensaje' => 'Especialista Editado']);
}
