...
class EspecialistaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'apellido' => 'required|string|max:40|min:3',
        ...
        // print_r($listaEspecialistas);exit;
        // return view('especialista.index',$listaEspecialistas);
        return redirect()->route('especialista.index')->with(['mensaje' => 'Especialista Agregado',$listaEspecialistas]);
    }
    ...
    public function destroy($id)
    {
        ...
        ->paginate(10);
        // print_r($listaEspecialistas);exit;
        // return view('especialista/index',$listaEspecialistas)->with(['mensaje' => 'Especialista Eliminado']);;
        return redirect()->route('especialista.index')->with(['mensaje' => 'Especialista Eliminado',$listaEspecialistas]);
    }
}
