...
class EspecialistaController extends Controller
{
    ...
    {
        //
        $listaEspecialistas['listaEspecialistas'] = Especialista::leftjoin("especialidades", "especialistas.id_especialidad", "=", "Especialidades.id_especialidad")
        ->select("*")
        ->get();
    ...
    public function store(Request $request)
    {
        ...
        $listaEspecialistas['listaEspecialistas'] = Especialista::join("especialidades", "especialistas.id_especialidad", "=", "Especialidades.id_especialidad")
        ->select("*")
        ->get();
        // print_r($listaEspecialistas);exit;
        return view('especialista/index',$listaEspecialistas);
