...
class EspecialistaController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($request->hasFile('foto')){
            ...
            Storage::delete('public/'.$datosEditEspe->foto);

            $datosEditProducto['foto']=$request->file('foto')->store('uploads/imagenEspecialista','public');
        }
//         print_r($datosEditProducto);
// exit;

        Especialista::where('id','=',$id)->update($datosEditProducto);
        $datosEditEspe=Especialista::findOrFail($id);
